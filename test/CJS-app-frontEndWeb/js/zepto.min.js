...
$.errTips = function (text, duration) {
    if(!text) return;
    ...
    var timeout = null;
    var $t = $('<div class="login-tip"><div class="msg msg-err"><p>'+text+'</p></div></div>').prependTo($('.container'));
    timeout=setTimeout(function(){
        $t.remove();
    }, duration);
}
/*选项卡切换 例子积分明细.html中*/
$.fn.tabSwitch = function (params) {
    var p = params || {
        tab: "cartTab li",
        tabClass: "current",
