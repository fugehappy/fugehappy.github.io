...
(function ($) {
    $.fn.date = function (options, Ycallback, Ncallback) {
		...
		var curYear = initY - parseInt(opts.beginyear) + 1;//当前年
        ...
        function init_iScrll(intoValue) {
            ...
            monthScroll = new iScroll("monthwrapper", {
                ...
                onScrollEnd: function () {
                    ...
                    opts.endday = checkdays(strY, strM);
					if(indexY === curYear && indexM === curMonth) {
						$("#daywrapper ul").html(createDAY_UL(1));
					} else {
						$("#daywrapper ul").html(createDAY_UL());
					}
        ...
        function addTimeStyle() {
            ...
            $("#yearwrapper").css("bottom", "208px");
            $("#monthwrapper").css("position", "absolute");
            $("#monthwrapper").css("bottom", "208px");
            $("#daywrapper").css("position", "absolute");
            $("#daywrapper").css("bottom", "208px");
        }
        //创建 --年-- 列表
        ...
        function createMONTH_UL(arg) {
			...
			if(typeof arg!=='undefined' && opts.limitCurDate){
				for (var i = opts.beginmonth; i <= curMonth; i++) {
					if (i < 10) {
						i = "0" + i
					}
					str += '<li>' + i + '月</li>'
        ...
        function createDAY_UL(arg) {
            ...
            var str = "<li>&nbsp;</li>";
			if(typeof arg !== 'undefined' && opts.limitCurDate) {
				for (var i = opts.beginday; i <= curDay; i++) {
					if (i < 10) {
						i = "0" + i
					}
					str += '<li>' + i + '日</li>';
