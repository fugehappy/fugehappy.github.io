...
!function(window, document, $) {
    ...
    $.extend($.site, {
        ...
        throttle: function(func, wait) {
            ...
            return function() {
                ...
                previous = now,
                result = func.apply(context, args),
                context = args = null) : timeout || (timeout = setTimeout(later, remaining)),
                result
            }
        },
        resize: function() {
    ...
    $.colors = function(name, level) {
        if ("primary" === name && (name = $.configs.get("site", "primaryColor"),
        name || (name = "red")),
        "undefined" == typeof $.configs.colors)
            return null;
    ...
    $.extend($.components, {
        ...
        _initApi: function(name, obj, args) {
            "undefined" == typeof obj.apiCalled && $.isFunction(obj.api) && (obj.api.apply(obj, args),
            obj.apiCalled = !0)
        },
...
!function(window, document, $) {
    ...
    window.Site = $.site.extend({
        run: function(next) {
            ...
            "undefined" != typeof $.site.menubar && ($(".site-menubar").on("changing.site.menubar", function() {
            ...
            "undefined" != typeof screenfull && ($(document).on("click", '[data-toggle="fullscreen"]', function() {
            ...
            if (pageAsideScroll.length > 0) {
                ...
                $(document).on("click.pageAsideScroll", ".page-aside-switch", function() {
                    ...
                    isOpen ? pageAside.removeClass("open") : (scrollable.update(),
...
$.components.register("appear", {
    ...
    api: function(context) {
        $.fn.appear && ($(document).on("appear", '[data-plugin="appear"]', function() {
            ...
            if (!animate) {
                animate = 'section';
                $item.removeClass("invisible").addClass(animate + "-animated");
            } else {
                $item.hasClass("appear-no-repeat") || ($item.removeClass("invisible").addClass("animation-" + animate),
                $item.data("repeat") === !1 && $item.addClass("appear-no-repeat"))
            }
        }),
        $(document).on("disappear", '[data-plugin="appear"]', function() {
            ...
            if (!animate) {
                animate = 'section';
                $item.addClass("invisible").removeClass(animate + "-animated");
            } else {
